...
function NohmoNextProvider({ children, projectId, apiKey, apiUrl, options = {}, }) {
    return (jsxs(NohmoProvider, { projectId: projectId, apiKey: apiKey, apiUrl: apiUrl, options: options, children: [jsx(NohmoNextInner, {}), children] }));
}

export { AutoCapture, NohmoNextProvider, NohmoProvider, NohmoTracker, useNohmo, useNohmo as useNohmoNext, usePageView };
